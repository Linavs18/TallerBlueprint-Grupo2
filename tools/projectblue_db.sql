...
INSERT INTO `projects` (`id`, `title`, `description`, `owner_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Sistema de Gestión Escolar', 'Aplicación para controlar notas, asistencia y reportes de alumnos.', 1, '2025-10-17 21:50:54', '2025-10-17 21:50:54', NULL),
	(2, 'App de Tareas Compartidas', 'Plataforma para asignar y seguir tareas de equipo.', 2, '2025-10-17 21:50:54', '2025-10-17 21:50:54', NULL),
	(3, 'Dashboard Financiero', 'Panel web para visualizar métricas y estadísticas financieras.', 1, '2025-10-17 21:50:54', '2025-10-17 21:50:54', NULL);
...
INSERT INTO `project_users` (`id`, `project_id`, `user_id`, `role`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 'admin', '2025-10-17 21:51:21', '2025-10-17 21:51:21'),
	(2, 1, 2, 'member', '2025-10-17 21:51:21', '2025-10-17 21:51:21'),
	(3, 2, 2, 'admin', '2025-10-17 21:51:21', '2025-10-17 21:51:21'),
	(4, 2, 1, 'member', '2025-10-17 21:51:21', '2025-10-17 21:51:21'),
	(5, 3, 1, 'admin', '2025-10-17 21:51:21', '2025-10-17 21:51:21');
...
INSERT INTO `tasks` (`id`, `name`, `description`, `status`, `due_date`, `project_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Diseñar base de datos', 'Crear modelo relacional y diagramas ER.', 'completado', '2025-10-01', 1, '2025-10-17 21:51:35', '2025-10-17 21:51:35', NULL),
	(2, 'Integrar autenticación', 'Configurar login y registro con Laravel Breeze.', 'en_progreso', '2025-10-20', 1, '2025-10-17 21:51:35', '2025-10-17 21:51:35', NULL),
	(3, 'Diseñar interfaz móvil', 'Mockups de la app para Android.', 'pendiente', '2025-10-30', 2, '2025-10-17 21:51:35', '2025-10-17 21:51:35', NULL),
	(4, 'Implementar API financiera', 'Crear endpoints para reportes de ingresos.', 'pendiente', '2025-11-10', 3, '2025-10-17 21:51:35', '2025-10-17 21:51:35', NULL),
	(5, 'Pruebas unitarias', 'Probar controladores y modelos.', 'en_progreso', '2025-10-25', 2, '2025-10-17 21:51:35', '2025-10-17 21:51:35', NULL);
...
-- Volcando datos para la tabla projectblue_bd.users: ~2 rows (aproximadamente)
INSERT INTO `users` (`id`, `name`, `email`, `password`, `created_at`, `updated_at`) VALUES
	(1, 'Wellington Schoen', 'factoryuser@example.com', '$2y$12$d3wDdRAOLzAjmrZmJtrmcujJbq4.jsI5tjViJSQh3bul2p4NoczXO', '2025-10-18 02:21:38', '2025-10-18 02:45:44'),
	(2, 'Usuario Prueba', 'test@example.com', '$2y$12$3EvS8TFXyRd/qPJ7Y1YeB.l8Rfubfz.O4KRg0VLnNxkDGS4sr1DSu', '2025-10-18 02:26:01', '2025-10-18 02:45:44');
